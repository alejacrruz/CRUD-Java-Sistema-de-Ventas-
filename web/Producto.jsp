                ...
                <div class="card-body">
                    <form action="Controlador?menu=Producto" method="POST">                  
                        <div class="form-group">
                            <label>Nombre</label>
                            <input type="text" value="${producto.getNom()}" name="txtNombrePro" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Precio</label>
                        ...
                        <div class="form-group">
                            <label>Estado</label>
                            <input type="text" value="${producto.getEstado()}" name="txtEstadoPro" class="form-control">
                        </div>
